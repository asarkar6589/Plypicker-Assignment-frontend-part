...
const Modal = ({ updateImage, closeModal }: Params) => {
    return (
        <div
        ...
        >
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full justify-center px-2 py-12 text-center ">
                    <div className="relative w-[95%] sm:w-[80%] min-h-[60vh] rounded-2xl bg-gray-100 text-black text-left shadow-xl transition-all">
